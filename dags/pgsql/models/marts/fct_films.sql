...
with films_2023 as (
    select 
        release_date,
        film_title,
        cast(total_audience as numeric) as total_audience,
        cast(ticket_collection as numeric) as ticket_collection
...
films_2022 as (
    select 
        release_date,
        film_title,
        cast(null as numeric) as total_audience,
        cast(ticket_collection as numeric) as ticket_collection
...
films_2021 as (
    select 
        ...
        film_title,
        cast(null as numeric) as total_audience,
        cast(null as numeric) as ticket_collection
